...
namespace uBuildCore.Models
{
    public class LoanProcessStages
    {
      ...
      public string LPS01InitialReviewDesc() {return  GetStatusName(LPS01InitialReview);}
      public string LPS02CreditAssessmentDesc() { return GetStatusName(LPS02CreditAssessment); }
      public string LPS03RiskAssessmentDesc() { return GetStatusName(LPS03RiskAssessment); }
      public string LPS04CreditApprovalDesc() { return GetStatusName(LPS04CreditApproval); }
      public string LPS05ClientConfirmationDesc() { return GetStatusName(LPS05ClientConfirmation); }
      public string LPS06LoanDisbursementDesc() { return GetStatusName(LPS06LoanDisbursement); }

        public string GetStatusName(int approvalCode)
        {
            List<LoanProcStageStates> stageStates = null; 
            if (stageStates != null)
            {
